      ...
      >
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-y-20 gap-x-5 mt-32">
          {FeaturesData.map((items, i) => (
            <div
              className="p-8 relative flex flex-col justify-center items-center rounded-3xl bg-gradient-to-b from-black/5 to-white dark:from-white/5 dark:to-black"
              key={i}
            >
              <div
                className="work-img-bg rounded-full flex justify-center absolute"
                style={{ top: "-20%" }}
              >
                <Image
                  src={items.imgSrc}
